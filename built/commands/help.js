...
module.exports = {
    help: {
        ...
        execute: function (message) { return __awaiter(_this, void 0, void 0, function () {
            var response, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, message.channel.send('', new Discord.RichEmbed()
                                .setTitle('I\'m the fellers bot - developed by your local\
								\nfellers. We are type scripting!  ')
                    ...
                    case 2:
                        error_1 = _a.sent();
                        logger.error("Help failed: " + error_1);
                        return [3 /*break*/, 3];
